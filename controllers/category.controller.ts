...
export const deleteCategoryAndItemsController = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const getCategoriesWithItemsByShopController = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    const response: SuccessResponse<typeof categories> = {
      message:
        req.lang === "ar"
          ? "تم استرجاع الفئات مع العناصر"
          : "Categories with items retrieved",
      data: categories,
    };
...
export const updateItemInCategoryController = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    const response: SuccessResponse<typeof updatedItem> = {
      message:
        req.lang === "ar"
          ? "تم تحديث العنصر في الفئة"
          : "Item updated in category",
      data: updatedItem,
    };
...
export const getItemsInCategoryController = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    const response: SuccessResponse<typeof items> = {
      message:
        req.lang === "ar"
          ? "تم استرجاع العناصر في الفئة"
          : "Items in category retrieved",
      data: items,
    };
