...
export const deleteCategoryAndItemsController: RequestHandler = async (req, res) => {
  const shopId = req.params.shopId;
  const categoryId = req.params.categoryId;
...
export const getCategoriesWithItemsByShopController: RequestHandler = async (req, res) => {
  const shopId = req.params.shopId;
  const lang = req.lang;
...
export const updateItemInCategoryController: RequestHandler = async (req, res) => {
...
export const getItemsInCategoryController: RequestHandler = async (req, res) => {
